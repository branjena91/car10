class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 156, y: height - 1390, image: obstacle2Image },
      { x: width / 2 + 233, y: height - 1700, image: obstacle2Image },
      { x: width / 2 - 669, y: height - 3389, image: obstacle2Image },
     
      { x: width / 2 - 155, y: height - 4378, image: obstacle2Image },
